...
res1_split = list(cv2.split(res1)) # 입력 다중 채널을 단일 채널로 분할, 튜플을 리스트 변환
# res1_split[0] = cv2.add(res1_split[0], -10) # 색상(H)
#res1_split[1] = cv2.add(res1_split[1], 10) # 채도(S)
#res1_split[2] = cv2.add(res1_split[2], 100) # 명도(V)
