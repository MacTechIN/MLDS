...
while True:
    ...
    if hour == 12 or 1 <= hour <= 2:
        ...
        x_pos = int(150.0 * sin((Ang_Hour - 270.0) * 3.141592 / 180))
        y_pos = int(150.0 * cos((Ang_Hour - 270.0) * 3.141592 / 180))
        cv2.line(img, (256, 256), (256 - x_pos, 256 - y_pos), (0, 255, 0), 6)

    if min == 00 or 1 <= hour <= 14:
        x_pos = int(200.0*cos((90-Ang_Min)*3.141692/180))
        y_pos = int(200.0*sin((90-Ang_Min)*3.141692/180))
        ...
        x_pos = int(200.0 * sin((Ang_Min - 270.0) * 3.141592 / 180))
        y_pos = int(150.0 * cos((Ang_Min - 270.0) * 3.141592 / 180))
        cv2.line(img, (256, 256), (256 - x_pos, 256 - y_pos), (255,0, 0), 1)
