...
# 영상 읽기
img1 = imgread(".././r /img14.jpg", cv2.IMREAD_GRAYSCALE, 320, 240)
...
#%%
ret, res = cv2.threshold(img1, thres, maxVal,cv2.THRESH_BINARY)

ress.append(cv2.adaptiveThreshold(img1, maxVal, cv2.ADAPTIVE_THRESH_MEAN_C ,cv2.THRESH_BINARY , 61, 0))
ress.append(cv2.adaptiveThreshold(img1, maxVal, methods[8], methods[0], 6))
name = "input1"
out = img1
