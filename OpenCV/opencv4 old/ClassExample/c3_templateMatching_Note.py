...
cv2.imshow('template imge', template)
...
w, h = template.shape[::-1] # 한줄로 처리 하기위해  
...
#%%
#추가 디버깅용  
    print(f"[res] {min_val}, {max_val}, {min_loc}, {max_loc}")
#%%
